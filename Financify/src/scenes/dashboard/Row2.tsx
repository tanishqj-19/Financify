...
import {Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, LineChart, PieChart, Pie, Cell, ScatterChart, Scatter, ZAxis } from 'recharts';
  ...
  return (
    ...
    <DashboardBox gridArea="f">
      ...
      <ResponsiveContainer width="100%" height={"100%"}>
          ...
          >
            <CartesianGrid stroke={palette.grey[600]}/>
            <XAxis 
